...
flags = tf.app.flags
flags.DEFINE_string("data_dir", "/Users/hzqb_luke/Desktop/tflearn/examples/images/mnist",
...
flags.DEFINE_string("ps_hosts", "172.16.122.130:2221",
                    "List of hostname:port for ps jobs."
                    "This string should be the same on every host!!")
flags.DEFINE_string("worker_hosts", "172.16.122.1:2222, 172.16.122.130:2223",
                    "List of hostname:port for worker jobs."
                    "This string should be the same on every host!!")

flags.DEFINE_string("job_name", "ps", "One of 'ps' or 'worker'")
...
def main(unused_argv):
    ...
    with tf.device(device_setter):
        ...
        '''if FLAGS.sync_replicas and is_chief:
            # Chief worker will start1 the chief queue runner and call the init op #
        ...
        while True:
            ...
            _, step, loss, summary = sess.run([train_op, global_step, cross_entropy, merged],
