...
flags.DEFINE_string("ps_hosts", "172.17.148.15:1324，172.17.148.13:1324",
                    "List of hostname:port for ps jobs."
                    "This string should be the same on every host!!")
flags.DEFINE_string("worker_hosts", "172.17.148.13:1325, 172.17.148.15:1325",#172.17.148.15:2223",
                    "List of hostname:port for worker jobs."
                    "This string should be the same on every host!!")

flags.DEFINE_string("job_name", "worker", "One of 'ps' or 'worker'")
